 ...
 */
type Arr = any[];
type MapFunc = (value: any, index: number, array: Arr) => void;
type ArrOrFunc = Arr | Function;
type AnyOrFunc = any | Function;
type NumOrFunc = number | Function;

export function map(mapper: MapFunc, input: Arr): ArrOrFunc {
    if (arguments.length === 0) {
        return map;
    }
    if (arguments.length === 1) {
        return function subFunction(subInput: Arr): ArrOrFunc {
            if (arguments.length === 0) {
                return subFunction;
            }
 ...
 * @return {Array | Function}
 */
type FilterFunc = (value: any, index: number, array: Arr) => void;
export function filter(filterer:FilterFunc, input: Arr):ArrOrFunc {
    if (arguments.length === 0) {
        return filter;
    }
    if (arguments.length === 1) {
 ...
 * @return {* | Function}
 */
type ReduceFunc = (previousValue: any, currentValue: any, currentIndex: number, array: Arr) => void;
export function reduce(reducer: ReduceFunc, initialValue: any, input: Arr): AnyOrFunc {
    if (arguments.length === 0) {
        return reduce;
    }
    if (arguments.length === 1) {
        return function subFunction(subInitialValue: any, subInput: Arr):AnyOrFunc {
            if (arguments.length === 0) {
                return subFunction;
            }
            if (arguments.length === 1) {
                return function subSubFunction(subSubInput: Arr):AnyOrFunc {
                    if (arguments.length === 0) {
    ...
    if (arguments.length === 2) {
        return function subFunction(subInput: Arr) {
            if (arguments.length === 0) {
                return subFunction;
            }
 ...
 */
export function add(a:number, b:number): NumOrFunc{
    if (arguments.length === 0) {
        return add;
    }
    if (arguments.length === 1) {
        return function subFunction(subB:number): NumOrFunc{
            if (arguments.length === 0) {
                return subFunction;
            }
            return a + subB;
 ...
 * @return {Number | Function}
 */
export function subtract(a: number, b: number):NumOrFunc {
    if (arguments.length === 0) {
        return subtract;
    }
    if (arguments.length === 1) {
 ...
 * @return {* | Function}
 */
export function prop(obj: Record<string, any>, propName: string):AnyOrFunc {
    if (arguments.length === 0) {
        return prop;
    }
    if (arguments.length === 1) {
        return function subFunction(subPropName: string):AnyOrFunc {
            if (arguments.length === 0) {
                return subFunction;
            }
